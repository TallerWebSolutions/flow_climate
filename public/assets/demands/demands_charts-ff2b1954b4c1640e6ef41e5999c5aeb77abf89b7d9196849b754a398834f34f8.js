function buildDemandsTabCharts() {
    ...
    const columnDemandLeadTimeBreakdownDiv = $("#portfolio-unit-lead-time-breakdown-column");
    if (columnDemandLeadTimeBreakdownDiv.length !== 0) {
        buildColumnChart(columnDemandLeadTimeBreakdownDiv);
    }
};
