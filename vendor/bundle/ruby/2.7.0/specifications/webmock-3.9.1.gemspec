...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/bblimke/webmock/issues", "changelog_uri" => "https://github.com/bblimke/webmock/blob/v3.9.1/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/webmock/3.9.1", "source_code_uri" => "https://github.com/bblimke/webmock/tree/v3.9.1", "wiki_uri" => "https://github.com/bblimke/webmock/wiki" } if s.respond_to? :metadata=
