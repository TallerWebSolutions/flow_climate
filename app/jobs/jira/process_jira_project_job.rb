...
module Jira
  class ProcessJiraProjectJob < ApplicationJob
    def perform(jira_account, project_jira_config, user_email, user_name, project_url)
      ...
      project_issues = Jira::JiraApiService.new(jira_account.username, jira_account.api_token, jira_account.base_uri).request_issues_by_fix_version(project_jira_config.jira_project_key, project_jira_config.fix_version_name)
