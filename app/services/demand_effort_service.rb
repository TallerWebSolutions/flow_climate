  ...
  def build_efforts_to_demand(demand)
    demand.demand_transitions.each do |transition|
      ...
      assignments_in_dates.each do |assignment|
        ...
        effort_total = (TimeService.instance.compute_working_hours_for_dates(start_date, end_date) * pairing_percentage * (1 + management_percentage) * stage_percentage) - total_blocked_in_assignment
