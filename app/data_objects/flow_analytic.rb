...
class FlowAnalytic
  ...
  def best_month_to_start_a_project(start_date)
    ...
    active_projects_count = ProjectsRepository.instance.active_projects_in_month(@company, start_date).count
  ...
  def financial_debt_to_sold_projects(start_date)
    ...
    money_to_month = ProjectsRepository.instance.money_to_month(@company, start_date)
