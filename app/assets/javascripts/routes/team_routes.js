...
function searchDemandsByFlowStatus(company_id, team_id, not_started, wip, delivered) {
    jQuery.ajax({
        url: "/companies/" + company_id + '/teams/' + team_id + "/search_demands_by_flow_status" + ".js",
        type: "GET",
        data: 'team_id=' + team_id + '&not_started=' + not_started + '&wip=' + wip + '&delivered=' + delivered
    });
}
