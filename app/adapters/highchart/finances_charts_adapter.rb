...
module Highchart
  class FinancesChartsAdapter
    ...
    def initialize(finances)
      @finances = finances.as_json.sort_by { |finances_hash| finances_hash['finances_date'] }
    end
    ...
    def finances_hash_with_computed_informations
      ...
      @finances.each do |finances_hash|
        ...
        finances_data << finances_hash_with_computed_data
      end
