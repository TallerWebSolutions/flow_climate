...
ActiveRecord::Schema[7.0].define(version: 20_220_214_141_346) do
  ...
  create_table 'class_of_service_change_histories', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[demand_id change_date], name: 'cos_history_unique', unique: true
  ...
  create_table 'contract_consolidations', force: :cascade do |t|
    ...
    t.index %w[contract_id consolidation_date], name: 'idx_contract_consolidation_unique', unique: true
  ...
  create_table 'customer_consolidations', force: :cascade do |t|
    ...
    t.decimal 'design_consumed_hours_in_month', default: '0.0', null: false
    t.decimal 'management_consumed_hours_in_month', default: '0.0', null: false
    t.index %w[customer_id consolidation_date], name: 'customer_consolidation_unique', unique: true
  ...
  create_table 'customers', force: :cascade do |t|
    ...
    t.index %w[company_id name], name: 'index_customers_on_company_id_and_name', unique: true
  ...
  create_table 'customers_devise_customers', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[customer_id devise_customer_id], name: 'idx_customers_devise_customer_unique', unique: true
  ...
  create_table 'customers_projects', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[customer_id project_id], name: 'index_customers_projects_on_customer_id_and_project_id', unique: true
  ...
  create_table 'demand_efforts', force: :cascade do |t|
    ...
    t.index %w[item_assignment_id demand_transition_id start_time_to_computation], name: 'idx_demand_efforts_unique', unique: true
  ...
  create_table 'demand_transitions', force: :cascade do |t|
    ...
    t.integer 'team_member_id'
    t.integer 'lock_version'
    t.index %w[demand_id stage_id last_time_in], name: 'idx_transitions_unique', unique: true
  ...
  create_table 'demands', force: :cascade do |t|
    ...
    t.index %w[external_id company_id], name: 'index_demands_on_external_id_and_company_id', unique: true
  ...
  create_table 'initiative_consolidations', force: :cascade do |t|
    ...
    t.index %w[initiative_id consolidation_date], name: 'initiative_consolidation_unique', unique: true
  ...
  create_table 'initiatives', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[company_id name], name: 'index_initiatives_on_company_id_and_name', unique: true
  ...
  create_table 'jira_custom_field_mappings', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[jira_account_id custom_field_type], name: 'unique_custom_field_to_jira_account', unique: true
  ...
  create_table 'jira_product_configs', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[company_id jira_product_key], name: 'index_jira_product_configs_on_company_id_and_jira_product_key', unique: true
  ...
  create_table 'jira_project_configs', force: :cascade do |t|
    ...
    t.index %w[jira_product_config_id fix_version_name], name: 'unique_fix_version_to_jira_product', unique: true
  ...
  create_table 'operations_dashboard_pairings', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[operations_dashboard_id pair_id], name: 'operations_dashboard_pairings_cache_unique', unique: true
  ...
  create_table 'operations_dashboards', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[team_member_id dashboard_date], name: 'operations_dashboard_cache_unique', unique: true
  ...
  create_table 'portfolio_units', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[name product_id], name: 'index_portfolio_units_on_name_and_product_id', unique: true
  ...
  create_table 'products', force: :cascade do |t|
    ...
    t.index %w[customer_id name], name: 'index_products_on_customer_id_and_name', unique: true
  ...
  create_table 'products_projects', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[product_id project_id], name: 'index_products_projects_on_product_id_and_project_id', unique: true
  ...
  create_table 'projects', force: :cascade do |t|
    ...
    t.index %w[company_id name], name: 'index_projects_on_company_id_and_name', unique: true
  ...
  create_table 'replenishing_consolidations', force: :cascade do |t|
    ...
    t.index %w[project_id consolidation_date], name: 'idx_replenishing_unique', unique: true
  ...
  create_table 'risk_reviews', force: :cascade do |t|
    ...
    t.index %w[meeting_date product_id], name: 'index_risk_reviews_on_meeting_date_and_product_id', unique: true
  ...
  create_table 'score_matrix_answers', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[answer_value score_matrix_question_id], name: 'idx_demand_score_answers_unique', unique: true
  ...
  create_table 'service_delivery_reviews', force: :cascade do |t|
    ...
    t.index %w[meeting_date product_id], name: 'index_service_delivery_reviews_on_meeting_date_and_product_id', unique: true
  ...
  create_table 'slack_configurations', force: :cascade do |t|
    ...
    t.index %w[info_type team_id], name: 'index_slack_configurations_on_info_type_and_team_id', unique: true
  ...
  create_table 'stage_project_configs', force: :cascade do |t|
    ...
    t.index %w[project_id stage_id], name: 'index_stage_project_configs_on_project_id_and_stage_id', unique: true
  ...
  create_table 'stages_teams', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[stage_id team_id], name: 'index_stages_teams_on_stage_id_and_team_id', unique: true
  ...
  create_table 'team_consolidations', force: :cascade do |t|
    ...
    t.index %w[team_id consolidation_date], name: 'team_consolidation_unique', unique: true
  ...
  create_table 'team_members', force: :cascade do |t|
    ...
    t.index %w[company_id name jira_account_id], name: 'index_team_members_on_company_id_and_name_and_jira_account_id', unique: true
  ...
  create_table 'teams', force: :cascade do |t|
    ...
    t.index %w[company_id name], name: 'index_teams_on_company_id_and_name', unique: true
  ...
  create_table 'user_company_roles', id: :serial, force: :cascade do |t|
    ...
    t.index %w[user_id company_id], name: 'index_user_company_roles_on_user_id_and_company_id', unique: true
  ...
  create_table 'user_project_roles', force: :cascade do |t|
    ...
    t.index %w[user_id project_id], name: 'index_user_project_roles_on_user_id_and_project_id', unique: true
