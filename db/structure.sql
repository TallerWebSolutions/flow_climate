...
--
-- Name: index_flow_impacts_on_discarded_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_flow_impacts_on_discarded_at ON public.flow_impacts USING btree (discarded_at);
...
--
-- Name: index_flow_impacts_on_risk_review_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_flow_impacts_on_risk_review_id ON public.flow_impacts USING btree (risk_review_id);
