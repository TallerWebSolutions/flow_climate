...
CREATE TABLE public.demands (
    ...
    leadtime numeric,
    manual_effort boolean DEFAULT false NOT NULL,
...
CREATE TABLE public.item_assignments (
    ...
    assignment_for_role boolean DEFAULT false NOT NULL,
...
CREATE TABLE public.stage_project_configs (
    ...
    project_id integer NOT NULL,
    stage_id integer NOT NULL,
    compute_effort boolean DEFAULT false NOT NULL,
...
CREATE TABLE public.stages (
    ...
    commitment_point boolean DEFAULT false NOT NULL,
    end_point boolean DEFAULT false NOT NULL,
