...
RSpec.describe FlowAnalyticData, type: :data_objects do
  ...
  describe '#financial_debt_to_sold_projects' do
    ...
    context 'having the financial informations' do
      ...
      let!(:projects) { Fabricate.times(2, :project, company: company, customers: [customer], start_date: Time.zone.today, end_date: Time.zone.today, value: 20) }
      let!(:other_projects) { Fabricate.times(2, :project, company: company, customers: [customer], start_date: 1.month.from_now, end_date: 1.month.from_now, value: 5) }
