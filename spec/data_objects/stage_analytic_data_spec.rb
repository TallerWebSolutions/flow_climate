  ...
  describe '.initialize' do
    ...
    context 'and the stage has transitions with duration' do
      ...
      it 'retrieves the last stages informations to the charts' do
        ...
        expect(stage_analytic_data.entrances_per_day).to eq(27.0 => { y: 2, color: 'rgb(247, 229, 83)' }, 28.0 => { y: 2, color: 'rgb(73, 142, 142)' }, 29.0 => { y: 1, color: 'rgb(73, 142, 142)' })
        ...
        expect(stage_analytic_data.avg_time_in_stage_per_month).to eq('Maio/2018' => { y: 19.0 })
      end
    end
