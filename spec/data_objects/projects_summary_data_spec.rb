...
RSpec.describe ProjectsSummaryData, type: :data_object do
  describe '#total_flow_pressure' do
    context 'having projects' do
      ...
      let!(:first_demand) { Fabricate :demand, project: project, external_id: 'foo', created_date: Time.zone.yesterday.beginning_of_day, commitment_date: nil, end_date: nil }
      let!(:second_demand) { Fabricate :demand, project: project, external_id: 'bar', created_date: 2.days.ago.beginning_of_day, commitment_date: nil, end_date: nil }

      let!(:third_demand) { Fabricate :demand, project: second_project, external_id: 'xpto', created_date: 3.days.ago.beginning_of_day, commitment_date: nil, end_date: nil }
