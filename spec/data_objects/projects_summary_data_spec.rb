...
RSpec.describe ProjectsSummaryData, type: :data_object do
  describe '#total_flow_pressure' do
    context 'having projects' do
      ...
      let!(:third_demand) { Fabricate :demand, project: second_project, created_date: 2.days.ago.beginning_of_day, end_date: nil }

      it { expect(projects_summary.total_flow_pressure).to be_within(0.5).of(0.5) }
    end
