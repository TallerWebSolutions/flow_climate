    ...
    context 'when reading transitions' do
      ...
      context 'when there is no transitions created yet' do
        it 'creates the transitions' do
          ...
          expect(Demand.last.demand_transitions.order(:last_time_in).map { |t| t.team_member&.name }).to eq [nil, 'team_member', 'team_member', 'team_member', 'team_member', 'other_team_member', 'other_team_member', 'other_team_member', 'other_team_member', 'other_team_member', 'other_team_member', 'other_team_member']
