    ...
    context 'when the demand does not exist' do
      ...
      context 'and it is a feature' do
        ...
        it 'creates the demand' do
          expect(Slack::SlackNotificationService.instance).to receive(:notify_demand_state_changed).twice
          ...
          expect(created_demand.memberships).to match_array [out_membership, membership, membership, other_membership]
      ...
      context 'with existent team members' do
        ...
        let!(:jira_issue) { client.Issue.build({ key: '10000', fields: { created: '2018-07-02T11:20:18.998-0300', summary: 'foo of bar', issuetype: { name: 'Story' }, customfield_10028: { value: 'Expedite' }, project: { key: 'foo' }, customfield_10024: [{ accountId: 'xpto', name: team_member.name }, { emailAddress: 'bar' }, { accountId: 'sbbrubles' }] }, changelog: { startAt: 0, maxResults: 2, total: 2, histories: [{ id: '10039', created: '2018-07-08T22:34:47.440-0300', author: { displayName: default_member.name }, items: [{ field: 'status', from: 'first_stage', to: 'second_stage' }] }, { id: '10038', created: '2018-07-06T09:40:43.886-0300', author: { displayName: default_member.name }, items: [{ field: 'status', from: 'third_stage', to: 'first_stage' }] }, { id: '10432', created: '2018-07-06T09:40:43.886-0300', author: { displayName: default_member.name }, items: [{ field: 'Responsible', fieldId: 'customfield_10024', from: "[#{team_member.name}]", to: "[#{team_member.name}]", toString: "[#{team_member.name}, #{other_team_member.name}]" }] }, { id: '10061', created: '2018-07-06T09:40:43.886-0300', author: { displayName: default_member.name }, items: [{ field: 'labels', fromString: nil, toString: 'xpto foo bla' }] }] } }.with_indifferent_access) }
      ...
      context 'and the issue returned to a previous stage and went forward again' do
        let!(:jira_issue) { client.Issue.build({ key: '10000', summary: 'foo of bar', fields: { created: '2018-07-02T11:20:18.998-0300', issuetype: { name: 'Story' }, customfield_10028: { value: 'Expedite' }, project: { key: 'foo' }, customfield_10024: [{ name: 'foo' }, { name: 'bar' }] }, changelog: { startAt: 0, maxResults: 2, total: 2, histories: [{ id: '10041', created: '2018-07-09T23:34:47.440-0300', author: { displayName: default_member.name }, items: [{ field: 'status', from: 'first_stage', to: 'second_stage' }] }, { id: '10040', created: '2018-07-09T22:34:47.440-0300', author: { displayName: default_member.name }, items: [{ field: 'status', from: 'second_stage', to: 'first_stage' }] }, { id: '10039', created: '2018-07-08T22:34:47.440-0300', author: { displayName: default_member.name }, items: [{ field: 'status', from: 'first_stage', to: 'second_stage' }] }, { id: '10038', created: '2018-07-06T09:40:43.886-0300', author: { displayName: default_member.name }, items: [{ field: 'status', from: 'third_stage', to: 'first_stage' }] }, { id: '10055', created: '2018-07-06T09:40:43.886-0300', author: { displayName: default_member.name }, items: [{ field: 'foo', from: 'third_stage', to: 'first_stage' }] }] } }.with_indifferent_access) }
