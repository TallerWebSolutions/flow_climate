    ...
    context 'when reading transitions' do
      ...
      context 'when there is no transitions created yet' do
        it 'creates the transitions' do
          ...
          expect(Demand.last.demand_transitions.order(:last_time_in).map { |transition| transition.last_time_in.iso8601 }).to eq %w[2020-07-31T09:11:27-03:00 2020-08-24T15:27:23-03:00 2020-08-25T09:45:35-03:00 2020-08-27T11:47:44-03:00 2020-08-27T11:47:46-03:00 2021-03-25T09:48:51-03:00 2021-03-26T12:52:57-03:00 2021-04-01T10:50:54-03:00 2021-04-01T14:19:48-03:00 2021-04-06T14:33:08-03:00 2021-04-06T16:22:39-03:00 2021-04-06T16:32:53-03:00]
      ...
      context 'when there were errors' do
        ...
        context 'in demand transition to saving slack NotNullViolation' do
          it 'registers the error in the logger and does not halt the demand saving' do
            allow_any_instance_of(DemandTransition).to(receive(:save)).and_raise(ActiveRecord::NotNullViolation)
            expect(Rails.logger).to(receive(:error)).once
