...
RSpec.describe Jira::JiraIssueAdapter, type: :service do
  ...
  let!(:jira_issue) { client.Issue.build({ id: '10000', summary: 'foo of bar', fields: { created: '2018-07-03T11:20:18.998-0300', issuetype: { name: 'Story' }, customfield_10028: { value: 'Expedite' }, project: { id: first_project.integration_id }, customfield_10024: [{ name: 'foo' }, { name: 'bar' }] } }.with_indifferent_access) }
        ...
        context 'having project_jira_config' do
          context 'and it is a feature' do
            ...
            it 'creates the demand' do
              ...
              expect(Demand.last.created_date).to eq Time.zone.parse('2018-07-03T11:20:18.998-0300')
            end
          end
