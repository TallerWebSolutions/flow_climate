  ...
  context 'with data' do
    it 'builds the burnup' do
      travel_to Time.zone.local(2022, 1, 27, 10, 0, 0) do
        ...
        expect(burnup.work_items).to match_array [first_task, second_task, third_task, fourth_task, fifth_task]
        ...
        expect(burnup.current_burn).to eq [0, 0, 1, 2, 4]
        expect(burnup.scope).to eq [0, 3, 4, 5, 5, 5, 5, 5]
      end
    end
  end
end
