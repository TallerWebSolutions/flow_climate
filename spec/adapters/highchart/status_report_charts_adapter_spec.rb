      ...
      context 'with projects' do
        it 'does the math and provides the correct information' do
          travel_to Time.zone.local(2018, 5, 1, 10, 0, 0) do
            ...
            Fabricate :demand, product: product, project: first_project, team: team, external_id: 'first_bug', work_item_type: bug_type, created_date: Time.zone.local(2018, 1, 15, 23, 1, 46), commitment_date: Time.zone.local(2018, 4, 30, 10, 1, 46), end_date: Time.zone.local(2018, 4, 30, 23, 1, 46), effort_upstream: 56, effort_downstream: 25
            Fabricate :demand, product: product, project: first_project, team: team, external_id: 'second_bug', work_item_type: bug_type, created_date: Time.zone.local(2018, 1, 15, 23, 1, 46), commitment_date: Time.zone.local(2018, 4, 25, 23, 1, 46), end_date: Time.zone.local(2018, 4, 30, 23, 1, 46), effort_upstream: 56, effort_downstream: 25
            Fabricate :demand, product: product, project: first_project, team: team, external_id: 'third_bug', work_item_type: bug_type, created_date: Time.zone.local(2018, 1, 15, 23, 1, 46), commitment_date: Time.zone.local(2018, 4, 29, 23, 1, 46), end_date: Time.zone.local(2018, 4, 30, 23, 1, 46), effort_upstream: 56, effort_downstream: 25
            Fabricate :demand, product: product, project: first_project, team: team, external_id: 'fourth_bug', work_item_type: bug_type, created_date: Time.zone.local(2018, 1, 15, 23, 1, 46), commitment_date: Time.zone.local(2018, 4, 29, 23, 1, 46), end_date: Time.zone.local(2018, 4, 30, 23, 1, 46), effort_upstream: 56, effort_downstream: 25
