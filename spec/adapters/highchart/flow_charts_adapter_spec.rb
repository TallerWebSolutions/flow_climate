  ...
  context 'having projects' do
    ...
    describe '.initialize' do
      ...
      it 'extracts the information of flow' do
        ...
        expect(flow_data.column_chart_data).to eq([{ name: 'Total Entrada', data: [1, 2, 2], stack: 0, yaxis: 0 }, { name: 'Processadas no Downstream', data: [1, 2, 1], stack: 1, yaxis: 1 }, { name: 'Processadas no Upstream', data: [0, 0, 1], stack: 1, yaxis: 1 }])
