  ...
  context 'having finances informations' do
    ...
    describe '.initialize' do
      it 'computes and extracts the information of finances' do
        ...
        expect(finances_hash[0]['expenses_total']).to eq 300.0
        expect(finances_hash[0]['std_dev_expenses']).to eq 0
        expect(finances_hash[0]['project_delivered_hours']).to eq 367.0
        ...
        expect(finances_hash[0]['throughput_in_month']).to eq 2
