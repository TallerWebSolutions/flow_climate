...
RSpec.describe Highchart::PortfolioChartsAdapter, type: :service do
  ...
  describe '#block_count_per_project' do
    ...
    context 'having blocks' do
      ...
      it 'builds the data structure for scope_data_evolution' do
        ...
        expect(statistics_data.block_count_per_project).to eq [{ data: [3], marker: { enabled: true }, name: I18n.t('portfolio.charts.block_count') }]
    ...
    context 'having no blocks' do
      ...
      it 'builds the data structure for scope_data_evolution' do
        ...
        expect(statistics_data.block_count_per_project).to eq [{ data: [], marker: { enabled: true }, name: I18n.t('portfolio.charts.block_count') }]
