...
RSpec.describe Highchart::ProjectsConsolidationsChartsAdapter, type: :service do
  ...
  describe '#lead_time_data_range_evolution' do
    ...
    context 'having projects' do
      ...
      let!(:fields_nil_project_consolidation) { Fabricate :project_consolidation, consolidation_date: 34.days.ago, project: first_project, lead_time_p25: nil, lead_time_histogram_bin_min: nil, lead_time_max: nil, lead_time_min: nil }
      ...
      context 'passing no date filter' do
        it 'builds the data structure for scope_data_evolution' do
          ...
          expect(consolidation_data.lead_time_data_range_evolution[:y_axis][0][:data]).to eq [1.3888888888888888e-05, 1.3888888888888888e-05]
          ...
          expect(consolidation_data.lead_time_data_range_evolution[:y_axis][1][:data]).to eq [2.4305555555555558e-05, 2.4305555555555558e-05]
          ...
          expect(consolidation_data.lead_time_data_range_evolution[:y_axis][2][:data]).to eq [2.5462962962962965e-05, 2.5462962962962965e-05]
        end
      end
    end
  end
