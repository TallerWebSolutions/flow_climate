    ...
    context 'having projects' do
      ...
      context 'passing no date filter' do
        it 'builds the data structure for scope_data_evolution' do
          ...
          expect(consolidation_data.lead_time_data_range_evolution[:y_axis][0][:data]).to eq [1.388888888888889e-05]
          ...
          expect(consolidation_data.lead_time_data_range_evolution[:y_axis][1][:data]).to eq [2.4305555555555554e-05]
          ...
          expect(consolidation_data.lead_time_data_range_evolution[:y_axis][2][:data]).to eq [2.546296296296296e-05]
        end
      end
    end
  end
    ...
    context 'having projects' do
      ...
      context 'passing no date filter' do
        it 'builds the data structure for scope_data_evolution' do
          ...
          expect(consolidation_data.lead_time_histogram_data_range_evolution[:y_axis][0][:data]).to eq [0.000115740740740741]
          ...
          expect(consolidation_data.lead_time_histogram_data_range_evolution[:y_axis][2][:data]).to eq [2.4305555555555554e-05]
        end
      end
    end
  end
    ...
    context 'having projects' do
      ...
      context 'passing no date filter' do
        it 'builds the data structure for scope_data_evolution' do
          ...
          expect(consolidation_data.lead_time_interquartile_data_range_evolution[:y_axis][0][:data]).to eq [3.4722222222222e-05]
          ...
          expect(consolidation_data.lead_time_interquartile_data_range_evolution[:y_axis][2][:data]).to eq [5.092592592592592e-05]
        end
      end
    end
  end

  describe '#lead_time_interquartile_histogram_range_evolution' do
    let(:company) { Fabricate :company }
    let(:customer) { Fabricate :customer, company: company }
    ...
    context 'having projects' do
      ...
      context 'passing no date filter' do
        it 'builds the data structure for scope_data_evolution' do
          ...
          expect(consolidation_data.lead_time_interquartile_histogram_range_evolution[:x_axis]).to eq [65.days.ago.to_date]
          expect(consolidation_data.lead_time_interquartile_histogram_range_evolution[:y_axis][0][:name]).to eq I18n.t('charts.lead_time_interquartile_histogram_range_evolution.total_range')
          expect(consolidation_data.lead_time_interquartile_histogram_range_evolution[:y_axis][0][:data]).to eq [8.1018518518519e-05]

          expect(consolidation_data.lead_time_interquartile_histogram_range_evolution[:y_axis][1][:name]).to eq I18n.t('charts.lead_time_interquartile_histogram_range_evolution.interquartile')
          expect(consolidation_data.lead_time_interquartile_histogram_range_evolution[:y_axis][1][:data]).to eq [3.4722222222222e-05]

          expect(consolidation_data.lead_time_interquartile_histogram_range_evolution[:y_axis][2][:name]).to eq I18n.t('charts.lead_time_interquartile_histogram_range_evolution.histogram')
          expect(consolidation_data.lead_time_interquartile_histogram_range_evolution[:y_axis][2][:data]).to eq [0.000115740740740741]
        end
      end
    end
  end
