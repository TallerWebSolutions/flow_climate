...
RSpec.describe Highchart::HighchartAdapter, type: :data_object do
  context 'having projects' do
    ...
    let!(:fourth_demand) { Fabricate :demand, project: first_project, end_date: Time.zone.parse('2018-03-18'), leadtime: 1 * 86_400, effort_upstream: 80, effort_downstream: 34 }
    let!(:fifth_demand) { Fabricate :demand, project: first_project, end_date: Time.zone.parse('2018-03-13'), leadtime: 4 * 86_400, effort_upstream: 56, effort_downstream: 25 }
