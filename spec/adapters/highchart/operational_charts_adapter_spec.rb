      ...
      context 'having projects' do
        ...
        context 'and filtering by last month' do
          ...
          it 'do the math and provides the correct information' do
            ...
            expect(report_data.weekly_queue_touch_count_hash).to eq(dates_array: %w[2018-04-09 2018-04-16 2018-04-23 2018-04-30 2018-05-07], queue_times: [0, 0, 1_987_200.0, 0, 0], touch_times: [0, 0, 0, 0, 0])
