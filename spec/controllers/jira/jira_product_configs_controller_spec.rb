...
RSpec.describe Jira::JiraProductConfigsController, type: :controller do
  ...
  context 'authenticated' do
    ...
    describe 'POST #create' do
      context 'passing valid parameters' do
        before { post :create, params: { company_id: company, product_id: product, jira_jira_product_config: { jira_product_key: 'xpto' } }, xhr: true }
        ...
        it 'creates the new product jira config' do
          ...
          expect(response).to render_template 'jira/jira_product_configs/create'
        end
      end
    ...
    describe 'DELETE #destroy' do
      ...
      context 'valid parameters' do
        ...
        it 'deletes the jira config' do
          expect(response).to render_template 'jira/jira_product_configs/destroy'
          expect(Jira::JiraProductConfig.last).to be_nil
        end
      end
