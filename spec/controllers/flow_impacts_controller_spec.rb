  ...
  context 'authenticated' do
      ...
      context 'passing invalid' do
        context 'company' do
          ...
          context 'not permitted' do
            ...
            before { get :new, params: { company_id: not_permitted_company } }
            it { expect(response).to have_http_status :not_found }
          end
        end
      end
    ...
    describe 'POST #create' do
      context 'valid parameters' do
        before { post :create, params: { company_id: company, flow_impact: { project_id: project, impact_type: :api_not_ready, impact_description: 'foo bar', start_date: Time.zone.local(2019, 4, 2, 12, 38, 0), end_date: Time.zone.local(2019, 4, 2, 15, 38, 0) } }, xhr: true }
      ...
      context 'passing invalid' do
        context 'parameters' do
          before { post :create, params: { company_id: company, flow_impact: { project_id: 'foo' } } }
        ...
        context 'company' do
          ...
          context 'not permitted' do
            let(:not_permitted_company) { Fabricate :company }
            before { post :create, params: { company_id: not_permitted_company } }
            it { expect(response).to have_http_status :not_found }
          end
        end
      end
