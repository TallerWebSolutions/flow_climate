        ...
        context 'with data' do
          it 'assigns the instance variables and renders the template' do
            travel_to Time.zone.local(2022, 5, 18, 10, 0, 0) do
              ...
              Fabricate :demand, product: product, team: team, project: first_project, demand_type: :feature, class_of_service: :standard, external_id: 'first_demand', created_date: 4.days.ago, commitment_date: 3.days.ago, end_date: 2.days.ago
              Fabricate :demand, product: product, team: team, project: second_project, demand_type: :bug, class_of_service: :standard, external_id: 'second_demand', created_date: 1.day.ago, commitment_date: 1.day.ago, end_date: 1.day.ago
              ...
              Fabricate :demand, product: product, team: team, project: fourth_project, demand_type: :chore, class_of_service: :intangible, external_id: 'fifth_demand', end_date: 3.hours.ago
        ...
        context 'with data' do
          it 'creates the objects and renders the tab' do
            travel_to Time.zone.local(2022, 5, 18, 10, 0, 0) do
              ...
              first_demand = Fabricate :demand, product: product, team: team, project: first_project, demand_type: :feature, class_of_service: :standard, external_id: 'first_demand', created_date: 4.days.ago, commitment_date: 3.days.ago, end_date: 2.days.ago
              second_demand = Fabricate :demand, product: product, team: team, project: second_project, demand_type: :bug, class_of_service: :standard, external_id: 'second_demand', created_date: 1.day.ago, commitment_date: 1.day.ago, end_date: 1.day.ago
