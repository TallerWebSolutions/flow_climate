...
RSpec.describe Slack::SlackNotificationService, type: :service do
  ...
  context 'having projects to collect data' do
    ...
    let!(:first_demand) { Fabricate :demand, project: project, demand_type: :bug, end_date: 1.week.ago, effort_downstream: 100, effort_upstream: 10 }
    let!(:second_demand) { Fabricate :demand, project: project, demand_type: :bug, end_date: 3.weeks.ago }
    let!(:third_demand) { Fabricate :demand, project: project, demand_type: :bug, end_date: 2.days.ago }
    let!(:fourth_demand) { Fabricate :demand, project: project, demand_type: :feature, end_date: 3.weeks.ago }
    let!(:fifth_demand) { Fabricate :demand, project: project, demand_type: :chore, end_date: Time.zone.now }
    let!(:sixth_demand) { Fabricate :demand, project: project, demand_type: :feature, end_date: 2.weeks.ago }
    let!(:seventh_demand) { Fabricate :demand, project: project, demand_type: :feature, end_date: Time.zone.now }
    let!(:eighth_demand) { Fabricate :demand, project: project, demand_type: :chore, commitment_date: Time.zone.now, end_date: nil, effort_downstream: 200, effort_upstream: 300 }
