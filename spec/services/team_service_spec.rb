...
RSpec.describe TeamService, type: :service do
  ...
  describe '#compute_average_demand_cost_to_team' do
    ...
    context 'with data' do
      ...
      let(:first_project) { Fabricate :project, product: product, team: team, customer: customer, project_type: :outsourcing, start_date: 1.month.ago, end_date: Time.zone.tomorrow }
      let(:second_project) { Fabricate :project, product: product, team: team, customer: customer, project_type: :outsourcing, start_date: 1.month.ago, end_date: Time.zone.tomorrow }
