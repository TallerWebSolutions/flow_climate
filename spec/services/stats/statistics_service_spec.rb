  ...
  describe '#run_montecarlo' do
    context 'having data' do
      ...
      it 'computes and provides the data' do
        expect(monte_carlo_simulation_data.dates_and_hits_hash.keys[0]).to be_within(6.days).of(1_524_452_400)
        expect(monte_carlo_simulation_data.dates_and_hits_hash.keys[1]).to be_within(6.days).of(1_524_020_400)
        expect(monte_carlo_simulation_data.dates_and_hits_hash.keys[2]).to be_within(6.days).of(1_524_020_400)
        expect(monte_carlo_simulation_data.dates_and_hits_hash.keys[3]).to be_within(6.days).of(1_524_020_400)

        expect(monte_carlo_simulation_data.dates_and_hits_hash.values[0]).to be_within(30).of(20)
        expect(monte_carlo_simulation_data.dates_and_hits_hash.values[1]).to be_within(30).of(20)
        expect(monte_carlo_simulation_data.dates_and_hits_hash.values[2]).to be_within(30).of(15)
        expect(monte_carlo_simulation_data.dates_and_hits_hash.values[3]).to be_within(30).of(5)

        expect(monte_carlo_simulation_data.monte_carlo_date_hash.keys[0]).to be_within(6.days).of(1_523_847_600)
        expect(monte_carlo_simulation_data.monte_carlo_date_hash.keys[1]).to be_within(6.days).of(1_524_020_400)
        expect(monte_carlo_simulation_data.monte_carlo_date_hash.keys[2]).to be_within(6.days).of(1_524_020_400)

        expect(monte_carlo_simulation_data.monte_carlo_date_hash.values[0].to_f).to be_within(0.3).of(0.22)
        expect(monte_carlo_simulation_data.monte_carlo_date_hash.values[1].to_f).to be_within(0.3).of(0.01)
        expect(monte_carlo_simulation_data.monte_carlo_date_hash.values[2].to_f).to be_within(0.3).of(0.23)
    ...
    context 'having no data' do
      ...
      it 'computes and provides the data' do
        ...
        expect(monte_carlo_simulation_data.monte_carlo_date_hash).to eq(1_523_502_000 => 1)
