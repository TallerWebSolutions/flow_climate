  ...
  describe '#request_issue_details' do
    context 'when the issue exists' do
      it 'returns the issue details' do
        ...
        issue_details = Jira::JiraApiService.new(jira_account.username, jira_account.api_token, jira_account.base_uri).request_issue_details('FC-3')
    ...
    context 'when the issue does not exist' do
      it 'returns an empty Issue' do
        ...
        issue_details = Jira::JiraApiService.new(jira_account.username, jira_account.api_token, jira_account.base_uri).request_issue_details('FC-1')
  ...
  describe '#request_issues_by_fix_version' do
    context 'when the project exists' do
      it 'returns the project' do
        ...
        Jira::JiraApiService.new(jira_account.username, jira_account.api_token, jira_account.base_uri).request_issues_by_fix_version('fix version name', 'FC')
      end
    end
  ...
  describe '#request_project' do
    context 'when the project exists' do
      it 'returns the project' do
        ...
        Jira::JiraApiService.new(jira_account.username, jira_account.api_token, jira_account.base_uri).request_project('10102')
      end
    end
    ...
    context 'when the project does not exist' do
      it 'returns an empty Issue' do
        ...
        project_returned = Jira::JiraApiService.new(jira_account.username, jira_account.api_token, jira_account.base_uri).request_project('EX')
  ...
  describe '#request_status' do
    context 'when the status exists' do
      it 'returns the project' do
        ...
        Jira::JiraApiService.new(jira_account.username, jira_account.api_token, jira_account.base_uri).request_status
      end
    end
    ...
    context 'when the status does not exist' do
      it 'returns an empty Issue' do
        ...
        returned_status = Jira::JiraApiService.new(jira_account.username, jira_account.api_token, jira_account.base_uri).request_status
