...
RSpec.describe RiskReviewService, type: :service do
  describe '#associate_demands_data' do
    ...
    let!(:sixth_demand) { Fabricate :demand, product: product, project: project, risk_review: nil, end_date: 4.days.ago, discarded_at: Time.zone.yesterday }
    ...
    let!(:sixth_impact) { Fabricate :flow_impact, project: project, demand: sixth_demand, risk_review: nil, start_date: 4.days.ago, discarded_at: Time.zone.yesterday }
