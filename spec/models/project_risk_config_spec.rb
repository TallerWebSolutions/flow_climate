...
RSpec.describe ProjectRiskConfig do
  context 'enums' do
    it { is_expected.to define_enum_for(:risk_type).with_values(no_money_to_deadline: 0, backlog_growth_rate: 1, not_enough_available_hours: 2, profit_margin: 3, flow_pressure: 4) }
  end
