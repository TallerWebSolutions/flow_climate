...
RSpec.describe SlackConfiguration do
  context 'enums' do
    it { is_expected.to define_enum_for(:info_type).with_values(average_demand_cost: 0, current_week_throughput: 1, last_week_delivered_demands_info: 2, demands_wip_info: 3, outdated_demands: 4, failure_load: 5, demand_state_changed: 6, item_assigned: 7, demand_blocked: 8, team_review: 9, weekly_team_efficiency: 10, monthly_team_efficiency: 11, monthly_team_efficiency_retrospective: 12) }
  end
