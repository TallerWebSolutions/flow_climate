...
RSpec.describe DemandBlocksRepository, type: :repository do
  describe '#blocks_to_projects_and_period' do
    ...
    context 'having data' do
      ...
      it 'returns the grouped data' do
        blocks_grouped_data = DemandBlocksRepository.instance.blocks_to_projects_and_period([first_project, second_project], first_project.start_date, second_project.end_date)
    ...
    context 'having no data' do
      it { expect(DemandBlocksRepository.instance.blocks_to_projects_and_period([first_project, second_project], first_project.start_date, second_project.end_date)).to eq({}) }
    end
  end
