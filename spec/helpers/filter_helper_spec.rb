...
RSpec.describe FilterHelper, type: :helper do
  ...
  describe '#flow_status_options' do
    it { expect(helper.flow_status_options).to eq options_for_select([[I18n.t('demands.filter.flow_status.all_demands'), :all_demands], [I18n.t('demands.filter.flow_status.not_started'), :not_started], [I18n.t('demands.filter.flow_status.work_in_progress'), :work_in_progress], [I18n.t('demands.filter.flow_status.delivered_demands'), :delivered_demands]], :all_demands) }
  end
