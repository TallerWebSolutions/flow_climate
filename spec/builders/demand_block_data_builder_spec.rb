...
RSpec.describe DemandBlockDataBuilder, type: :builder do
  describe '#build_data_from_hash_per_week' do
    context 'having info in the hash' do
      ...
      it { expect(DemandBlockDataBuilder.instance.build_block_per_stage(info_data_hash)).to eq('bla' => 92_895.06483333332, 'ble' => 89.56511111111112, 'bli' => 271_577.41066666663) }
    end
